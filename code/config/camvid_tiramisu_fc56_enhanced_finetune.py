...
# Model
model_name = 'tiramisu_fc56'  # Model to use
...
weights_file = '/home/master/data/master/Experiments/camvid/tiramisu_fc56_enhanced/weights.hdf5'
...
resize_train = (256, 352)  # Resize the image during training (Height, Width) or None
resize_valid = (256, 352)  # Resize the image during validation
resize_test = (256, 352)  # Resize the image during testing
...
lrDecayScheduler_epochs = [200, 350]  # List of epochs were decay is applied or None for all epochs
...
LRScheduler_type = 'sqrt'  # Type of scheduler ['linear' | 'step' | 'square' | 'sqrt' | 'poly']
LRScheduler_M = 500  # Number of iterations/epochs expected until convergence
