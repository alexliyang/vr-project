...
batch_size_valid = 300  # Batch size during validation
batch_size_test = 300  # Batch size during testing
...
lrDecayScheduler_epochs = [10, 20, 30, 40]   # List of epochs were decay is applied or None for all epochs
