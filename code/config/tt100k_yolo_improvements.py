...
weights_file = '/home/master/data/master/Experiments/TT100K_detection/baseline_yolo/weights.hdf5'  # Training weight file name
...
lrDecayScheduler_epochs = [8]  # List of epochs were decay is applied or None for all epochs
