...
TH_WEIGHTS_PATH = 'https://github.com/fchollet/deep-learning-models/releases/download/v0.2/' \
                  'resnet50_weights_th_dim_ordering_th_kernels.h5'
TF_WEIGHTS_PATH = 'https://github.com/fchollet/deep-learning-models/releases/download/v0.2/' \
                  'resnet50_weights_tf_dim_ordering_tf_kernels.h5'
TH_WEIGHTS_PATH_NO_TOP = 'https://github.com/fchollet/deep-learning-models/releases/download/v0.2/' \
...
def build_resnet50(img_shape=(3, 224, 224), n_classes=1000, weight_decay=0.0001,
    ...
    x = Dense(n_classes, W_regularizer=l2(weight_decay), b_regularizer=l2(weight_decay),
              name='fc{}'.format(n_classes))(x)
...
def identity_block(input_tensor, kernel_size, filters, stage, block, weight_decay=0.0001):
    ...
    x = Convolution2D(nb_filter1, 1, 1, W_regularizer=l2(weight_decay),
                      b_regularizer=l2(weight_decay), name=conv_name_base + '2a')(input_tensor)
    x = BatchNormalization(axis=bn_axis, name=bn_name_base + '2a')(x)
    x = Activation('relu')(x)

    x = Convolution2D(nb_filter2, kernel_size, kernel_size, W_regularizer=l2(weight_decay),
                      b_regularizer=l2(weight_decay), border_mode='same', name=conv_name_base + '2b')(x)
    x = BatchNormalization(axis=bn_axis, name=bn_name_base + '2b')(x)
    x = Activation('relu')(x)

    x = Convolution2D(nb_filter3, 1, 1, W_regularizer=l2(weight_decay),
                      b_regularizer=l2(weight_decay), name=conv_name_base + '2c')(x)
...
def conv_block(input_tensor, kernel_size, filters, stage, block, strides=(2, 2), weight_decay=0.0001):
    ...
    x = Convolution2D(nb_filter1, 1, 1, subsample=strides, W_regularizer=l2(weight_decay),
                      b_regularizer=l2(weight_decay),
                      name=conv_name_base + '2a')(input_tensor)
    x = BatchNormalization(axis=bn_axis, name=bn_name_base + '2a')(x)
    x = Activation('relu')(x)

    x = Convolution2D(nb_filter2, kernel_size, kernel_size, border_mode='same', W_regularizer=l2(weight_decay),
                      b_regularizer=l2(weight_decay),
    ...
    shortcut = Convolution2D(nb_filter3, 1, 1, subsample=strides, W_regularizer=l2(weight_decay),
                             b_regularizer=l2(weight_decay),
...
def resnet50(include_top=True, weights='imagenet',
             ...
             classes=1000, weight_decay=0.0001):
    ...
    x = Convolution2D(64, 7, 7, subsample=(2, 2), W_regularizer=l2(weight_decay),
                      b_regularizer=l2(weight_decay), name='conv1')(x)
    ...
    if include_top:
        ...
        x = Dense(classes, activation='softmax', W_regularizer=l2(weight_decay),
                  b_regularizer=l2(weight_decay), name='fc1000')(x)
