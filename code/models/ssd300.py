...
def build_ssd300(img_shape = (300, 300, 3), n_classes = 80, weight_decay = 0., load_pretrained = False, freeze_layers_from = 'base_model'):
    ...
    base_model = ssd300(input_shape=img_shape, num_classes=n_classes, include_top=False, weight_decay= weight_decay)

    model = prediction_layers(base_model, img_shape, num_classes=n_classes, weight_decay= weight_decay)
...
def prediction_layers(base_model, img_size, num_classes = 80, weight_decay = weight_decay):
    net = base_model
